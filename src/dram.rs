...
impl Dram {
    ...
    pub fn store(self, addr: u64, size: u64, data: u64) -> Result<(), ()> {
        match size {
    ...
    fn store64(self, addr: u64, data: u64) {
        let index = (addr - DRAM_BASE) as usize;
